...
const Profile = () => {
  const { user, loading, updateUser, isAuthenticated, logout } = useAuth();
                ...
                <div className="flex space-x-3">
                  ...
                  {!isEditing && (
                    <button
                      ...
                      className="bg-red-500/80 backdrop-blur-sm text-white px-6 py-3 rounded-2xl font-medium hover:bg-red-600/90 transition-all duration-300 border border-red-400/30 hover:scale-105 shadow-lg"
                    >
                      <span className="flex items-center space-x-2">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 transform transition-all duration-300 scale-100">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Delete Profile</h3>
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 bg-gray-100 text-gray-700 px-6 py-3 rounded-2xl font-medium hover:bg-gray-200 transition-all duration-300"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-red-600 text-white px-6 py-3 rounded-2xl font-medium hover:bg-red-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <span className="flex items-center justify-center space-x-2">
